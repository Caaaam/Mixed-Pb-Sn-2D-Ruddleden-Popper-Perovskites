...
for i in range(1,5):
    if i <= 2:
        plt.subplot2grid((nrows,ncols), (2,i))
    else:
...
for i in range(5,7):
    plt.subplot2grid((nrows,ncols), (4,i-4))
...
for i in range(11,15):
    if i <= 12:
        plt.subplot2grid((nrows,ncols), (7,i-10))
    else:
        plt.subplot2grid((nrows,ncols), (8,i-12))
...
plt.savefig('PEA2PbSnI4_SoC_DOS_VBM_CBM_Comparison_Labels.pdf')